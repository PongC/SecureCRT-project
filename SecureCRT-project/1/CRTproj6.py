...
error_file = open(LOG_DIRECTORY+"error.txt")
...
def ssh(ip):
	...
	send_list=["","pwu2k@AAA","yes","screen-length 0 temporary","screen-length 0 temporary"]
	...
	if(nIndex==0):
		...
		error_file.write("LOGIN:ERROR"+" ip: "+ip+ " (no condition matched in wait_list)")
